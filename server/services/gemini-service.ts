...
მთავარი წესი: როცა მომხმარებელი ნებისმიერ პროდუქტს ახსენებს, ᲐᲣᲪᲘᲚᲔᲑᲚᲐᲓ გამოიძახე search_products ფუნქცია. არასოდეს უპასუხო "რას ეძებთ?" თუ უკვე ახსენა პროდუქტი.

წესები:
- ყოველთვის უპასუხე ქართულად
- search_products-ში query უნდა იყოს ზუსტად ის სიტყვა რაც მომხმარებელმა თქვა (მაგ: "კვერცხი", "რძე", "კოკა კოლა")
...
- store_type: საკვები/სასმელი → "grocery", ტექნიკა → "electronics"`;
