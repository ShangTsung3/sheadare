...
const ALTA_CONFIG = {
  ...
  source: 'alta',
  categories: [
    { id: 16, name: 'ტელეფონები', url: 'https://alta.ge/mobiluri-telefonebi-c16s' },
    { id: 17, name: 'სმარტ საათები', url: 'https://alta.ge/smart-saatebi-c17s' },
    { id: 22, name: 'ყურსასმენები', url: 'https://alta.ge/usadeno-yursasmeni-c22s' },
    { id: 34, name: 'ნოუთბუქი', url: 'https://alta.ge/noutbuqi-c34s' },
    { id: 41, name: 'ტაბლეტები', url: 'https://alta.ge/tabletebi-c41s' },
    { id: 50, name: 'ტელევიზორები', url: 'https://alta.ge/televizorebi-c50s' },
    { id: 56, name: 'მონიტორები', url: 'https://alta.ge/monitori-c56s' },
    { id: 59, name: 'კომპიუტერები', url: 'https://alta.ge/kompiuteri-c59s' },
    { id: 67, name: 'გეიმინგი', url: 'https://alta.ge/gaming-c67s' },
    { id: 86, name: 'სამზარეულო', url: 'https://alta.ge/samzareulo-c86s' },
    { id: 91, name: 'პერსონალური მოვლა', url: 'https://alta.ge/personaluri-movla-c91s' },
  ],
